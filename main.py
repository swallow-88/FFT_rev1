    ...
    def _stft_bg(self):
        ...
        try:
            ...
            def _update(_dt,
                ...
                texs = [
                    heatmap_to_texture(arrs[0],vmin=-40 if MEAS_MODE=="VEL" else -50,
                                       vmax= 40 if MEAS_MODE=="VEL" else  50, lut=TURBO),
                    heatmap_to_texture(arrs[1],vmin=-40 if MEAS_MODE=="VEL" else -50,
                                       vmax= 40 if MEAS_MODE=="VEL" else  50, lut=TURBO),
