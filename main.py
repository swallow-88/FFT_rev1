    ...
    def _stft_bg(self):
        ...
        try:
            ...
            def _update(_dt,
                ...
                texs = [
                    heatmap_to_texture(arrs[0],vmin=-80 if MEAS_MODE=="VEL" else -80,
                                       vmax= 80 if MEAS_MODE=="VEL" else  80, lut=TURBO),
                    heatmap_to_texture(arrs[1],vmin=-80 if MEAS_MODE=="VEL" else -80,
                                       vmax= 80 if MEAS_MODE=="VEL" else  80, lut=TURBO),
